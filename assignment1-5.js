...
let get = `Hello ${fullName}, Would you like to learn some Typescrpt today?`;
console.log(get);
//QUESTION 03:
...
let famous_Person = "Molana Rumi";
let message = `${famous_Person} once said; "Everything that is made beautiful and fair and lovely is made for the eye of one who sees."`;
console.log(message);
